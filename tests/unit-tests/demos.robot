...
Get Test Cases
    ...
    ...  ${scripts_path}${/}single-node${/}i386_64-kvm-linux.resc       '{system}' ${eq} 'Linux' and '{arch}' ${eq} 'x64'
    ...  ${scripts_path}${/}single-node${/}i386_64-kvm-bios.resc        '{system}' ${eq} 'Linux' and '{arch}' ${eq} 'x64'
