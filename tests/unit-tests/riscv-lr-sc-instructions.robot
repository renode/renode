...
Contended Memory Value Should Increment To Correct Sum
    ...
    # The assembly instructions to execute in this test.
    # It repeatedly increments the value in (a0) until enough loop iterations have run.
    ${ASSEMBLY_INCREMENT_LOOP}=  catenate  SEPARATOR=
    ...    repeat: lr.d a4, (a0);
    ...    add a4, a4, a2;
    ...    sc.d a4, a4, (a0);
    ...    bnez a4, repeat;
    ...
    ${assembly_size_1}=    Execute Command                 u54_1 AssembleBlock ${CORE_1_PC} "${ASSEMBLY_INCREMENT_LOOP}"
    ${assembly_size_2}=    Execute Command                 u54_2 AssembleBlock ${CORE_2_PC} "${ASSEMBLY_INCREMENT_LOOP}"
    ...
    Wait For Line On Uart  u54_1 finished  testerId=${virtual-console1}  timeout=1 
    Wait For Line On Uart  u54_2 finished  testerId=${virtual-console2}  timeout=1 
