...
Create Machine
    ...
    Execute Command             sysbus WriteByte 0x00280028 ${id}
    Execute Command             sysbus WriteByte 0x0028002C 0x00
    Execute Command             sysbus WriteByte 0x00280030 0xAB
    Execute Command             sysbus WriteByte 0x00280034 0x89
    Execute Command             sysbus WriteByte 0x00280038 0x00
    Execute Command             sysbus WriteByte 0x0028003C 0x4B
    Execute Command             sysbus WriteByte 0x00280040 0x12
    Execute Command             sysbus WriteByte 0x00280044 0x00
