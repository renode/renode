...
def create_coverview_archive(path: TextIO, coverage_config: Coverage, coverview_dict: str, *, tests_as_total: bool, warning_threshold: str | None, remove_common_path_prefix: bool = False) -> bool:
    merge_config = {}
    success = True
